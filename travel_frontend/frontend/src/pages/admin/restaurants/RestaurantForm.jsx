        ...
        <div className="min-h-screen bg-gray-50/30 pb-20 pt-10 px-6">
            <div className="max-w-4xl mx-auto relative z-10">
                <div className="bg-white/90 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-xl border border-gray-100 animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <button type="button" onClick={handleCancel} className="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-orange-500 mb-8 transition-colors bg-white px-4 py-2 rounded-full shadow-sm border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-orange-50/50 p-6 rounded-3xl border border-orange-100 mb-8">
                            <label className="block text-sm font-bold text-gray-900 mb-3 flex items-center gap-2"><MapPin size={18} className="text-orange-500"/> Select Destination</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea required rows="4" value={description} onChange={(e) => setDescription(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg resize-none"></textarea>
                            </div>

                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><MapPin size={16} className="text-orange-500"/> Latitude</label>
                                <input type="number" step="any" required value={latitude} onChange={(e) => setLatitude(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" placeholder="41.8902" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><MapPin size={16} className="text-orange-500"/> Longitude</label>
                                <input type="number" step="any" required value={longitude} onChange={(e) => setLongitude(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" placeholder="12.4922" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="any" required value={averageCost} onChange={(e) => setAverageCost(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" placeholder="1500" />
                            </div>
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><Clock size={16} className="text-orange-500"/> Opening Time</label>
                                <input type="time" required value={openingTime} onChange={(e) => setOpeningTime(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" />
                            </div>

                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><Clock size={16} className="text-orange-500"/> Closing Time</label>
                                <input type="time" required value={closingTime} onChange={(e) => setClosingTime(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" />
                            </div>

                            <div className="md:col-span-2">
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><Users size={16} className="text-orange-500"/> Max Guests Per Slot</label>
                                <input type="number" required value={maxGuests} onChange={(e) => setMaxGuests(e.target.value)} className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all font-medium text-lg" placeholder="50" />
                            </div>

                            <div className="p-5 bg-gray-50 rounded-2xl border border-gray-100">
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><UploadCloud size={16}/> {isEditMode ? 'Replace Signature Image' : 'Main Signature Dish Image'}</label>
                                <input type="file" required={!isEditMode} onChange={handleMainImageChange} accept="image/*" className="text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-orange-100 file:text-orange-700 hover:file:bg-orange-200 cursor-pointer w-full" />
                            ...
                            <div className="p-5 bg-orange-50/50 rounded-2xl border border-orange-100">
                                <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2"><Images size={16} className="text-orange-500"/> {isEditMode ? 'Replace Menu Gallery' : 'Dining Area & Menu Gallery'}</label>
                                ...
                                {galleryPreviews.length > 0 && (
                                    <div className="mt-4 flex gap-3 overflow-x-auto pb-2">
                                        {galleryPreviews.map((src, i) => <img key={i} src={src} alt="Gallery" className="h-20 w-20 object-cover rounded-xl shadow-sm border border-orange-200 flex-shrink-0" /> )}
                                    </div>
                                )}
